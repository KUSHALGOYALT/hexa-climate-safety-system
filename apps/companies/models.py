...
class Company(models.Model):
    """Single company model - Hexa Climate"""
    name = models.CharField(max_length=200, default='Hexa Climate')
    company_code = models.CharField(max_length=20, unique=True, default='HEXA001')
